...
{{ include "quantum-lib.resources.preset" "nano" -}}
*/}}
{{- define "quantum-lib.resources.preset" -}}
...
{{-   range $baseCPU }}
{{-     $_ := set . "limits" (dict "cpu" (include "quantum-lib.resources.toFloat" .requests.cpu | float64 | mulf $cpuAllocationRatio | toString)) }}
{{-   end }}
{{-   range $baseMemory }}

...
import (
	...
	"github.com/quantumreasoning/quantumreasoning/pkg/apis/apps/v1alpha1"
	"github.com/quantumreasoning/quantumreasoning/pkg/apiserver"
	"github.com/quantumreasoning/quantumreasoning/pkg/config"
	sampleopenapi "github.com/quantumreasoning/quantumreasoning/pkg/generated/openapi"
...
func (o *AppsServerOptions) Config() (*apiserver.Config, error) {
	...
	serverConfig.OpenAPIConfig.PostProcessSpec = func(swagger *spec.Swagger) (*spec.Swagger, error) {
		...
		appDef, exists := defs["com.github.quantumreasoning.quantumreasoning.pkg.apis.apps.v1alpha1.Application"]
		if !exists {
			return swagger, fmt.Errorf("Application definition not found")
		}

		listDef, exists := defs["com.github.quantumreasoning.quantumreasoning.pkg.apis.apps.v1alpha1.ApplicationList"]
		if !exists {
		...
		for _, gvk := range v1alpha1.RegisteredGVKs {
			...
			// "com.github.quantumreasoning.quantumreasoning.pkg.apis.apps.v1alpha1.Bucket"
			resourceName := fmt.Sprintf("com.github.quantumreasoning.quantumreasoning.pkg.apis.apps.v1alpha1.%s", gvk.Kind)
			...
			listResourceName := fmt.Sprintf("com.github.quantumreasoning.quantumreasoning.pkg.apis.apps.v1alpha1.%sList", gvk.Kind)
		...
		delete(defs, "com.github.quantumreasoning.quantumreasoning.pkg.apis.apps.v1alpha1.Application")
		delete(defs, "com.github.quantumreasoning.quantumreasoning.pkg.apis.apps.v1alpha1.ApplicationList")

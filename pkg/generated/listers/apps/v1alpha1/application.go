...
type ApplicationLister interface {
	...
	List(selector labels.Selector) (ret []*appsv1alpha1.Application, err error)
...
type applicationLister struct {
	listers.ResourceIndexer[*appsv1alpha1.Application]
}

// NewApplicationLister returns a new ApplicationLister.
func NewApplicationLister(indexer cache.Indexer) ApplicationLister {
	return &applicationLister{listers.New[*appsv1alpha1.Application](indexer, appsv1alpha1.Resource("application"))}
}

// Applications returns an object that can list and get Applications.
func (s *applicationLister) Applications(namespace string) ApplicationNamespaceLister {
	return applicationNamespaceLister{listers.NewNamespaced[*appsv1alpha1.Application](s.ResourceIndexer, namespace)}
}
...
type ApplicationNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*appsv1alpha1.Application, error)

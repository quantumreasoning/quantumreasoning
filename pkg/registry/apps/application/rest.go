...
import (
	...
	appsv1alpha1 "github.com/quantumreasoning/quantumreasoning/pkg/apis/apps/v1alpha1"
...
const (
	LabelPrefix      = "apps.quantumreasoning.io-"
	AnnotationPrefix = "apps.quantumreasoning.io-"
)
...
func (r *REST) Get(ctx context.Context, name string, options *metav1.GetOptions) (runtime.Object, error) {
	...
	unstructuredApp["apiVersion"] = "apps.quantumreasoning.io/v1alpha1"

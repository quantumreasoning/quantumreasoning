...
var configMapNames = []string{"quantumreasoning", "quantumreasoning-branding", "quantumreasoning-scheduling"}

const configMapNamespace = "quantum-system"
const digestAnnotation = "quantumreasoning.io/quantum-config-digest"
...
func (r *QuantumreasoningConfigReconciler) Reconcile(ctx context.Context, _ ctrl.Request) (ctrl.Result, error) {
	...
	for _, hr := range helmList.Items {
		isSystemApp := hr.Labels["quantumreasoning.io/system-app"] == "true"

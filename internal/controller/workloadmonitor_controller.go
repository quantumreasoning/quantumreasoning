...
// +kubebuilder:rbac:groups=quantumreasoning.io,resources=workloadmonitors,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=quantumreasoning.io,resources=workloadmonitors/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=quantumreasoning.io,resources=workloads,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=quantumreasoning.io,resources=workloads/status,verbs=get;update;patch
...
func (r *WorkloadMonitorReconciler) reconcileServiceForMonitor(
	ctx context.Context,
	monitor *quantumv1alpha1.WorkloadMonitor,
	svc corev1.Service,
) error {
	logger := log.FromContext(ctx)
	workload := &quantumv1alpha1.Workload{
...
func (r *WorkloadMonitorReconciler) reconcilePodForMonitor(
	...
	// If annotation "workload.quantumreasoning.io/resources" is present, parse and merge
	if resourcesStr, ok := pod.Annotations["workload.quantumreasoning.io/resources"]; ok {
...
func (r *WorkloadMonitorReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		...
		For(&quantumv1alpha1.WorkloadMonitor{}).
...
func (r *WorkloadMonitorReconciler) getWorkloadMetadata(obj client.Object) map[string]string {
	...
	if instanceType, ok := annotations["kubevirt.io/cluster-instancetype-name"]; ok {
		labels["workloads.quantumreasoning.io/kubevirt-vmi-instance-type"] = instanceType
	}
	return labels
}

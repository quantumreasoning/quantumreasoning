...
import (
	...
	quantumreasoningiov1alpha1 "github.com/quantumreasoning/quantumreasoning/api/v1alpha1"
	"github.com/quantumreasoning/quantumreasoning/internal/controller"
	"github.com/quantumreasoning/quantumreasoning/internal/telemetry"
...
func init() {
	...
	utilruntime.Must(quantumreasoningiov1alpha1.AddToScheme(scheme))
...
func main() {
	...
	var quantumreasoningVersion string
	...
	flag.StringVar(&telemetryEndpoint, "telemetry-endpoint", "https://telemetry.quantumreasoning.io",
		"Endpoint for sending telemetry data")
	flag.StringVar(&telemetryInterval, "telemetry-interval", "15m",
		"Interval between telemetry data collection (e.g. 15m, 1h)")
	flag.StringVar(&quantumreasoningVersion, "quantumreasoning-version", "unknown",
		"Version of quantumreasoning")
	opts := zap.Options{
		Development: false,
	}
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "19a0338c.quantumreasoning.io",
